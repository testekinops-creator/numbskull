// Maps each game mode to its premium GameIcon glyph key. Shared by Home, Lobby,
// MatchRoom, Spectator, etc. (RMCS/Rummy reuse close-fit marks).
export const GAME_ICON_KEY = {
