    ...
    return (
      <div className="screen">
        ...
        <div className={`panel ${styles.page}`}>
          ...
          <h1 className={styles.title} style={{ display: 'inline-flex', alignItems: 'center', gap: 10 }}><GameIcon icon="queens" size={26} /> Queens</h1>
    ...
    <div className="screen">
      ...
      <div className={`panel ${styles.page}`}>
        <div className={styles.header}>
          ...
          <span className={styles.progress} style={{ display: 'inline-flex', alignItems: 'center', gap: 5 }}><GameIcon icon="queens" size={15} /> {queensPlaced}/{puzzle.n}</span>
        </div>
